			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Email is required">
						...
						<input class="input100" type="text" name="add" placeholder="Enter Email Adress">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Phoneno is required">
						<span class="label-input100"> Number</span>
						<input class="input100" type="text" name="num" placeholder="Enter Phone Number">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Phoneno is required">
						<span class="label-input100"> DOB</span>
						<input class="input100" type="text" name="dob" placeholder="Enter DOB">
						<span class="focus-input100"></span>
					</div>
